...
public class RabbitsGrassSimulationModel extends SimModelImpl {		
		...
		public static void main(String[] args) {
			...
			RabbitsGrassSimulationModel model = new RabbitsGrassSimulationModel();
                ...
                private int grassGrowRate = 15; //how
                private int birthThreshold = 30;
                private int grassEnergy = 10;
                private int maxStartEnergy = 27;//energy rabbits are born with...
                private int minStartEnergy = 17;
    ...
    public void setBirthThreshold(int birthThreshold) {
		...
		public String[] getInitParam() {
			// TODO Auto-generated method stub
			String[] initParams ={ "NumRabbits" , "WorldXSize" , "WorldYSize" , "Money", "grassGrowRate", "grassEnergy","grass", "birthThreshold", "maxStartEnergy","minStartEnergy"};
                        return initParams;
		}
		...
		public void setup() {
			...
			System.out.println("setup");
                ...
                public void buildSchedule(){
                    ...
                    schedule.scheduleActionAtInterval(30/grassGrowRate,new CarryDropCountGrass() );
                ...
                private int giveBirth(){
                    ...
                    for (int i=0; i<rabbitList.size();i++){
                        Rabbit r = (Rabbit) rabbitList.get(i);
                        if(r.getEnergy()>getBirthThreshold()){addRabbits++;}
                    }
                ...
                private int countLivingRabbits(){
                    ...
                    for (int i=0; i<rabbitList.size();i++){
                        Rabbit r = (Rabbit) rabbitList.get(i);
                        if(r.getEnergy()>0){livingRabbits++;}
                    }
